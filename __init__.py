...
### 2. Create a study
    ...
    project = Project("prism.project.yaml")
...
# Validation
from .config_validator import ConfigValidator, load_and_validate, validate_config

# Schema parsing
from .schema_parser import SchemaParser, SchemaValidator, SchemaDefinition
